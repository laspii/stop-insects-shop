...
const products = [
    {
        ...
        desc: { uk: '5-6 флаконів. Локальна обробка.', ru: '5-6 флаконов. Локальная обработка.' },
    ...
    },
    {
        ...
        desc: { uk: '10-12 флаконів. 1 кімната.', ru: '10-12 флаконов. 1 комната.' },
    ...
    },
    {
        ...
        desc: { uk: '20-25 флаконів. Тотальна зачистка.', ru: '20-25 флаконов. Тотальная зачистка.' },
