...
const products = [
    {
        id: 'test', price: 150, tag: { uk: 'Тест', ru: 'Тест' },
        img: 'flakon01.jpg', // Сюда вставьте ссылку на ваше фото
        title: { uk: 'Один флакон, тестовий', ru: 'Один флакон, тестовый' },
        desc: { uk: 'Один флакон. Локальна обробка.<br>Вбивця клопів №1. Засіб «Метод» — аналог професійної дезінсекції, але в 3 рази дешевше. Вбиває комах за 4 години, захищає до 21 дня. Працює проти резистентних популяцій. Оригінал.', ru: '6 флаконов. Локальная обработка.' },
        marketing: { uk: 'Протестувати.', ru: 'Протестировать.' }
    },
    {
        id: 'basic', price: 550, tag: { uk: 'Старт', ru: 'Старт' },
    ...
    {
        id: 'reinforced', price: 1000, tag: { uk: 'Хіт', ru: 'Хит' },
    ...
    },
    {
        ...
        img: 'flakon20.jpg', // Сюда вставьте ссылку на ваше фото
