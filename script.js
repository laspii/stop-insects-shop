...
const products = [
    {
        ...
        desc: { uk: '6 флаконів. Локальна обробка.<br>Вбивця клопів №1. Засіб «Метод» — аналог професійної дезінсекції, але в 3 рази дешевше. Вбиває комах за 4 хвилини, захищає до 21 дня. Працює проти резистентних популяцій. Оригінал.', ru: '6 флаконов. Локальная обработка.' },
